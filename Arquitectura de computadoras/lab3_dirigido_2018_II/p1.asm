...
;32h de tal manera que enviando un “01” por el puerto serie seleccione una frecuencia de 2
;hertz, enviando un “02” seleccione 12 hertz, enviando “03” seleccione 22 hertz y
;enviando “04” seleccione 32 hertz. La señal saldrá por el pin P1.0 del Puerto 1.
;Sugerencia: Usar el timer 0 en modo 0.
